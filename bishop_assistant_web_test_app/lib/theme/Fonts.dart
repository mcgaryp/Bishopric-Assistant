...
const TextStyle buttonStyle = TextStyle(color: whiteText);
const TextStyle titleStyle = TextStyle(color: whiteText, fontSize: 48);
const TextStyle title2Style = TextStyle(color: blackText, fontSize: 24);
